...
const MovieCard = ({ movie }: { movie: Movie }) => {
  ...
  return (
    <div className="relative h-fit w-fit after:absolute after:inset-0 after:z-[-1] after:rounded-md after:opacity-0 after:shadow-[0_0_20px_black] after:duration-300 after:content-[''] hover:after:opacity-100 hover:after:duration-300">
      <div
