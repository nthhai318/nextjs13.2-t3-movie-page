...
const MovieCard = ({ movie }: { movie: Movie }) => {
  ...
  return (
    ...
    >
      <div className="mt-8 bg-gradient-to-t from-black via-black px-3 text-slate-200 transition-all duration-500 group-focus-within:max-h-96  group-focus-within:duration-75 group-hover:max-h-96 sm:max-h-0">
